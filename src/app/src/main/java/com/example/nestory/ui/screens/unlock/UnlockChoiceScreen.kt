...
fun UnlockRoute(
    ...
    val devicePasswordPromptInfo = remember {
        BiometricPrompt.PromptInfo.Builder()
            .setTitle("Mở khóa bằng password thiết bị")
...
data class UnlockUiState(
    ...
    val description: String
        get() = when {
            ...
            fingerprintAvailability == UnlockAvailability.Available ||
                ...
                "Chọn vân tay hoặc password thiết bị để truy cập giấy tờ của bạn."
    ...
    val devicePasswordActionLabel: String
        get() = when {
            authenticating == UnlockMethod.DevicePassword -> "Đang mở password thiết bị..."
            else -> "Mở khóa bằng password thiết bị"
        }
    ...
    val statusMessage: String?
        get() = errorMessage ?: when {
            ...
            fingerprintAvailability == UnlockAvailability.Available ->
                "Password thiết bị chưa sẵn sàng. Bạn vẫn có thể mở khóa bằng vân tay."

            devicePasswordAvailability == UnlockAvailability.Available ->
                "Vân tay chưa sẵn sàng. Bạn vẫn có thể mở khóa bằng password thiết bị."
